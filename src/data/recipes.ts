...
export const recipes: Recipe[] = [
    ...
    createRecipe({
        ...
        categoryId: 9,
        tag: ["간식"],
        imgUrl: "images/DXl_vyGD4xH.png",
        videoUrl: "",
        sourceUrl: "https://www.instagram.com/p/DXl_vyGD4xH/",
        ingredients: [
            "가래떡",
            "",
        ],
    ...
    createRecipe({
        ...
        categoryId: 2,
        tag: ["무침"],
        imgUrl: "images/DUiDaGVEqls.png",
        videoUrl: "",
        sourceUrl: "https://www.instagram.com/p/DUiDaGVEqls/",
        ingredients: [
            "양배추 1/4통",
            "청포묵 1팩",
            "당근 1개",
        ...
        steps: [
            "당근은 껍질째 깨끗이 씻어 채칼로 얇게 썰고, 양배추도 먹기 좋게 채 썰어 준비합니다.",
            "김이 오른 찜기에 손질한 양배추와 당근을 넣고 딱 2분간 쪄줍니다.",
            "청포묵은 먹기 좋은 크기로 길게 썰어줍니다.",
            "끓는 물에 소금 1T을 넣고 썰어둔 청포묵을 넣어 2분간 데친 뒤, 투명해지면 찬물에 헹궈 탱글탱글한 식감을 살립니다.",
            "볼에 들깨가루 2, 들기름 2, 국간장 2, 다진 마늘 1T을 섞어 고소한 양념장을 만듭니다.",
            "넓은 볼에 쪄낸 채소와 물기를 뺀 청포묵, 가위로 자른 김, 양념장을 넣고 골고루 버무려줍니다.",
            "마지막으로 뇌 건강에 좋은 호두를 굵게 다져 뿌려주면 완성입니다.",
        ]
    }),
    createRecipe({
        title: "등촌샤브 2인분",
        ...
        categoryId: 3,
        tag: [],
        imgUrl: "images/DWoDANuk6SA.png",
        videoUrl: "",
        sourceUrl: "https://www.instagram.com/p/DWoDANuk6SA/",
        ingredients: [
            "물1리터",
            "코인육수 2알",
            "큰 양파 반 개",
        ...
        steps: [
            "[볶음밥용 재료]올리브유 약간, 밥 1공기, 국물 1국자, 다진 당근과 미나리 약간, 달걀 1개",
            "[간장 소스]진간장2T, 물4T, 알룰로스0.8T(한스푼 약간 안되게), 식초1.5T, 연겨자 또는 와사비 약간",
            "미나리는 한 입 크기로 자르고 버섯도 밑둥을 잘라 준비해두고, 분량의 양념 재료를 넣고 육수 양념장과 찍어먹을 간장 소스를 미리 만들어둬요",
            "냄비에 물 1리터를 붓고 코인육수 2알과 양념장 넣어 끓어오르면, 채 썬 양파 넣고 한소끔 끓으면 미나리, 버섯, 소고기 넣고 익혀서 간장소스에 찍어 먹어요.",
            "샤브샤브 즐긴 후에 취향따라 칼국수 사리 넣고, 마지막으로 죽이나 볶음밥 해먹으면 되는데, 칼국수는 끓는 물에 한 번 충분히 데쳐서 넣어야 국물이 깔끔해요",
            "볶음밥에 넣을 당근은 최대한 잘게 다져주세요. 샤브국물+맛소금 살짝 또는 샤브국물+다시다 약간(식당 맛)으로 간해서 볶아주거나, 아니면 아예 샤브국물을 넉넉히 넣고 죽으로 해도 맛있어요🫶🏻",
        ]
    }),
    createRecipe({
        title: "지코바 치킨 닭다리살 덮밥 5인분",
        chef: "김진순",
        categoryId: 5,
        tag: ["덮밥"],
        imgUrl: "images/DULDHR3gXwW.png",
        videoUrl: "",
        sourceUrl: "https://www.instagram.com/p/DULDHR3gXwW/",
        ingredients: [
            "닭다리살(순살) 350그람 * 4팩",
            "대파 1대",
            "청양고추 10개",
        ...
        steps: [
            "닭고기 잡내 잡기 위해 맛술 10T, 맛소금 1/2, 후추 톡톡 뿌려서 20분 재워주세요",
            "20분 지났으면 팬에 식용유 반컵 두르고 껍질 부터 차례대로 올려서 노릇하게 구워주세요!",
            "닭고기가 노릇해 졌으면 얇게썬 대파 추가해서 2분 더 볶아주고 여기에 소스 넣고 물 1컵 넣고 5분 조려주세요!",
            "취향에 따라 청양고추 넣고 한번 섞어주세요",
            "흰 쌀밥위에 최대한 얇게썬 양파 올리고 닭고기 올려주고 계란까지 올려주면 완성!",
        ]
    }),
    createRecipe({
        title: "청경채 무침",
        ...
        categoryId: 0,
        tag: [],
        imgUrl: "images/DXTuabKgbid.png",
        videoUrl: "",
        sourceUrl: "https://www.instagram.com/p/DXTuabKgbid/",
        ingredients: [
            "청경채 3개(180g)",
            "당근 2/3개(190g)",
        ],
        ...
        steps: [
            "청경채는 흐르는 물에 깨끗이 씻어 준비합니다.",
            "당근은 껍질에 항암 영양소가 풍부하므로 깨끗이 씻어 껍질째 채칼로 얇게 채 썰어줍니다.",
            "채반에 손질한 청경채와 당근을 모두 올리고 찜기에 넣어 딱 2분만 짧게 쪄내어 영양소 파괴를 최소화합니다.",
            "쪄낸 채소들은 한 김 식힌 뒤, 짤순이에 넣고 물기를 꽉 짜서 수분을 완벽하게 제거해 줍니다.",
            "볼에 저온압착 생들기름 2T, 국산콩 양조간장 1T, 유기농 레드와인 식초 1T, 다진 마늘 반 T을 넣고 잘 섞어 소스를 만듭니다.",
            "볼에 수분을 뺀 찐 채소들을 넣고 만들어둔 소스를 부어 골고루 잘 버무려줍니다.",
            "마지막으로 들깨가루 1T을 넣고 한 번 더 섞어주어 채소의 남은 수분을 잡고 풍미를 올려 완성합니다.",
        ]
    }),
    createRecipe({
        title: "두부조림",
        ...
        categoryId: 2,
        tag: ["조림"],
        imgUrl: "images/DXtbGnBEq4K.png",
        videoUrl: "",
        sourceUrl: "https://www.instagram.com/p/DXtbGnBEq4K/",
        ingredients: [
            "부침용 두부 500g 한 모",
            "대파",
            "청양고추",
        ...
        steps: [
            "두부는 먹기 좋게 썰어주고 소금 세 꼬집으로 밑간을 하고 키친타올을 이용해 물기를 제거해주세요.",
            "양념장을 만들어주세요.",
            "달궈진 팬에 식용유 3T, 들기름 1T 둘러 물기 뺀 두부를 앞, 뒤로 노릇노릇하게 구워주세요.",
            "양념을 조금씩 두부위에 올려주고 남은 양념장에 종이컵으로 1/2 정도 물을 부어 자박자박하게 졸여주면 완성이에요.",
        ]
    }),
    createRecipe({
        title: "토마토 마리네이드",
        ...
        categoryId: 9,
        tag: [],
        imgUrl: "images/DXrJB5Uk7VB.png",
        videoUrl: "",
        sourceUrl: "https://www.instagram.com/p/DXrJB5Uk7VB/",
        ingredients: [
            "토마토",
            "바질",
            "양파",
        ...
        steps: [
            "바질과 양파는 다지고, 토마토는 1cm 두께로 슬라이스",
            "용기 바닥에 레드발사믹, 토마토, 바질+양파, 레드발사믹, 올리브오일 순서로 켜켜이 쌓아주기",
            "바로 먹어도 좋고, 냉장보관 하며 먹어도 좋아요 /n * 보관은 냉장 일주일까지!",
        ]
    }),
    createRecipe({
        title: "매콤한 오징어잡채",
        ...
        categoryId: 2,
        tag: [],
        imgUrl: "images/DXqtgL6jHGD.png",
        videoUrl: "",
        sourceUrl: "https://www.instagram.com/p/DXqtgL6jHGD/",
        ingredients: [
            "오징어 2마리",
            "당면 한줌",
            "양파 1/2개",
        ...
        steps: [
            "뜨거운 물을 준비하시고 당면 한줌을 넣어 불려주세요,",
            "오징어를 2마리를 배 가르고 내장 뼈 제거한 후에 입과 눈을 빼시고 깨끗하게 씻어 준비를 해주세요.",
            "배쪽에 칼집을 촘촘히 넣고 한입 크기로 썰어 주시면 오징어 손질은 끝입니다.",
            "여기에 양념을 넣어 잘 섞어 오징어를 양념에 재워주세요.",
            "이제 달궈진 팬에 채소들을 넣고 센 불에서 빠르게 볶아주시고 따로 빼주세요",
            "그리고 불려놓은 당면과 양념한 오징어 순으로 넣고 볶아주시면 됩니다.",
            "오징어가 돌돌돌 말리면서 익게 되면 준비한 채소들을 넣고 한번 더 볶아주세요.",
            "여기에 참기름 참깨를 넣고 마무리 해주시면 됩니다.",
        ]
    }),
    createRecipe({
        title: "초간단 저당 무피클",
        ...
        categoryId: 1,
        tag: [],
        imgUrl: "images/DXHH-eSFLK5.png",
        videoUrl: "",
        sourceUrl: "https://www.instagram.com/p/DXHH-eSFLK5/?img_index=1",
        ingredients: [
            "무 1/2개",
            "오이 1개",
            "파프리카 1~2개",
        ...
        seasonings: [
            "물 4컵",
            "식초 2컵",
            "가루 알룰로스 or 설탕 or 자일로스 설탕 2컵",
            "소금 1T",
            "피클링스파이스 1T",
        ],
        steps: [
            "모든 채소는 먹기 좋은 크기로 자른 뒤 열탕소독한 유리병에 넣어주세요.",
            "냄비에 단촛물 재료를 넣어 끓여주세요.",
            "끓어오르면 바로 유리병에 부어줍니다. 식힌 뒤 냉장고에 넣어주세요.",
            "* 끓을 때 부어야 피클이 더 아삭해요.",
            "* 냉장고에 하루 이틀 숙성시키면 더 맛있습니다.",
            "* 단촛물은 1~2번 더 재사용하세요.",
        ]
    }),
    createRecipe({
        ...
        categoryId: 6,
        tag: ["파스타"],
        imgUrl: "images/DX1f1bAT6YU.png",
        videoUrl: "",
        sourceUrl: "https://www.instagram.com/p/DX1f1bAT6YU/",
        ingredients: [
            "스파게티니 100g",
            "새우 30미 7마리",
            "양파 40g, 작은 사이즈 1/4개",
            "샐러드 믹스 80g(로메인, 라디치오, 와일드 루꼴라)",
        ],
        seasonings: [
            "엑스트라 버진 올리브 오일 3T",
            "발사믹 식초 3T",
        ...
        steps: [
            "새우가 냉동 제품 이라면 소금 물에 해동시켜준 뒤 등에 칼집을 넣어준다",
            "양파는 얇게 채 썰어 찬 물에 담가주고 샐러드 믹스는 한 입 크기로 잘라준다",
            "끓는 물(1L)에 소금(2t)을 넣고 스파게티니를 5~6분간 삶아주는 데 이때 손질된 새우를 같이 넣고 1분만 데쳐 찬물에 헹궈준다",
            "삶아진 파스타는 넓은 볼에 담아 물에 절대 헹구지 않고 그대로 식혀준다",
            "마늘은 곱게 다져 용기에 담아 발사믹 식초 3T, 소금 1/2t, 후추 한두꼬집을 넣고 소금이 완전 녹도록 섞어준 뒤 오일을 넣고 마저 섞어준다",
            "식은 면에 드레싱 절반을 넣고 버무려 준 뒤 준비된 모든 채소들과 새우 그리고 남은 드레싱을 모두 넣어준 뒤 그라나 파다노 치즈를 살짝 갈아 섞어주면 완성",
        ]
    }),
    createRecipe({
        title: "미즈컨테이너 st. 샐러드 파스타",
        chef: "",
        categoryId: 6,
        tag: ["파스타"],
        imgUrl: "images/DX0G7NSyitW.png",
        videoUrl: "",
        sourceUrl: "https://www.instagram.com/p/DX0G7NSyitW/",
        ingredients: [
            "파스타면 1인분",
            "방울토마토 10알",
            " 베이컨 4줄",
        ...
        steps: [
            "물에 올리브유, 소금 넣고 파스타면 삶아주세요",
            "양파는 얇게 잘라 찬물에 담궈주세요",
            "베이컨 잘라 팬에 구워주고 새우도 후추뿌려 구워주세요",
            "간장 2T, 설탕 2T, 식초 3T, 올리브오일 3T, 굴소스 1/2T, 다진마늘 1/2T 넣고 소스 만들어주세요",
            "접시에 샐러드채소 담고 파스타면 담고 방울토마토, 양파, 새우, 베이컨, 콘옥수수 올려주고 드레싱 뿌려주면 요즘같은 날씨에 찰떡인 샐러드 파스타 완성",
        ]
    }),
    createRecipe({
        title: "애호박나물",
        ...
        categoryId: 2,
        tag: ["나물"],
        imgUrl: "images/DMK7IowSShR.png",
        videoUrl: "",
        sourceUrl: "https://www.instagram.com/p/DMK7IowSShR/",
        ingredients: [
            "애호박 4개",
            "청고추 1개",
            "홍고추 1개",
        ...
        steps: [
            "애호박은 채칼로 가운데 씨만 빼고 채쳐주세요. 가운데 씨는 된장국에 넣으면 부드럽고 맛있습니다",
            "청고추, 홍고추도 채썰어주세요",
            "팬에 다진마늘 1T, 청고추채, 식용유 2T 넣고 마늘을 투명하게 악혀주세요.",
            "애호박을 넣고 중불에서 덥혀준다는 느낌으로 볶아주세요",
            "살짝 나른해 지면 새우젓 국물 2T, 연두 1T (없으면 진간장 대체) 간이 부족하면 소금 한꼬집, 홍고추채, 물 1잔 50ml 넣고 뚜껑 닫고 강불에서 1분",
            "불을 끄고 들기름 1T, 통깨 1/2T, 고춧가루 약간 (선택) 넣고 마무리",
        ]
    }),
    createRecipe({
        title: "건강하게 먹을 수 있는 라면",
        chef: "박민혁셰프",
        categoryId: 6,
        tag: [],
        imgUrl: "images/DHVl8nlvQtr.png",
        videoUrl: "",
        sourceUrl: "https://www.instagram.com/p/DHVl8nlvQtr/",
        ingredients: [
            "라면 1개",
            "브로콜리니",
            "미니배추",
        ...
        steps: [
            "라면 끓이기!",
            "좋아하는 채소(당근, 컬리플라워 등)를 모아 라면 위에 함께 찌기!",
            "딥핑소스 재료는 한데 모아 갈아주기!",
            "찐 채소에 올리브 오일, 후리가케 뿌려 마무리!",
            "라면 & 채소를 소스에 찍어 먹으면 끝!",
        ]
    }),
    createRecipe({
